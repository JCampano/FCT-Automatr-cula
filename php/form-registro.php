			...
			<fieldset>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" class="form-control" name="contrasena2" id="contrasena2" placeholder="Repetir contrase&ntilde;a"><span class="invalid-feedback">Introduzca una contraseña mínimo de <strong>5 letras/números  las contraseñas deben coincidir</strong></span>
                    </div>
                    <div class="col-md-4 mb-3">
