			...
			<fieldset>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" autofocus="autofocus" class="form-control" name="contrasena" id="contrasena" placeholder="Contrase&ntilde;a" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ,º0-9\s]{5,40}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="password" class="form-control" name="contrasena2" id="contrasena2" placeholder="Repetir contrase&ntilde;a" required>
                    </div>
                    <div class="col-md-4 mb-3">
