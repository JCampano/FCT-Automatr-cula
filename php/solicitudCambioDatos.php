...
<div class="tab-content">
	<form name="frmSolicitudCambioDatos" class="needs-validation" novalidate>
			...
			<fieldset>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="nombre" placeholder="Nombre" required pattern="[a-zA-Z\s]{3,40}" value = "<?php echo $alumno['nombre'];?>">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="apellido1" placeholder="Primer apellido" required pattern="[a-zA-Z\s]{3,40}" value = "<?php echo $alumno['apellido1'];?>">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="apellido2" placeholder="Segundo Apellido" required pattern="[a-zA-Z\s]{3,40}" value = "<?php echo $alumno['apellido2'];?>">
                        <span class="invalid-feedback">Introducir un apellido <strong>debe constar mínimo de 3 letras</strong></span>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="nie" placeholder="NIE" required pattern="^[XYZ]\d{7,8}[A-Z]$" value = "<?php echo $alumno['nie'];?>">
                        <span class="invalid-feedback">El campo NIE debe constar de <strong>1 letra, 7 números y 1 letra</strong></span>
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="dni" class="control-label">DNI</label>
                        <input type="text" class="form-control" name="dni" placeholder="DNI" required pattern="\d{8}\w" value = "<?php echo $alumno['dni'];?>">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="direccion" placeholder="Dirección" required pattern="[a-zA-Z\s]{3,40}" value = "<?php echo $alumno['direccion'];?>">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" name="fecha_nac" placeholder="Fecha Nacimiento" value = "<?php echo $alumno['fecha_nac'];?>">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="poblacion" placeholder="Población" required pattern="[a-zA-Z\s]{3,40}" value = "<?php echo $alumno['poblacion'];?>">
                        <span class="invalid-feedback">Introducir una población <strong>debe constar mínimo de 3 letras</strong></span>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="provincia" class="control-label">Provincia</label>
                        <input type="text" class="form-control" name="provincia" placeholder="Población" required pattern="[a-zA-Z\s]{3,40}" value = "<?php echo $alumno['provincia'];?>">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="cod_postal" placeholder="Código postal" required pattern="^(?:0[1-9]\d{3}|[1-4]\d{4}|5[0-2]\d{3})$" value = "<?php echo $alumno['cod_postal'];?>">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="tel_fijo" placeholder="Teléfono fijo" required pattern="^\d{9}$" value = "<?php echo $alumno['tel_fijo'];?>">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="tel_movil" placeholder="Teléfono móvil" required pattern="^\d{9}$" value ="<?php echo $alumno['tel_movil'];?>">
                        <span class="invalid-feedback">Introducir un teléfono móvil <strong>debe constar de 9 dígitos</strong></span>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="email" class="control-label">E-mail</label>
                        <input type="text" class="form-control" name="E-mail" placeholder="email" required pattern="^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$" value ="<?php echo $alumno['correo'];?>">
			...
			<fieldset>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="nombre_padre" placeholder="Nombre del padre" required pattern="[a-zA-Z\s]{3,40}" value ="<?php echo $alumno['nombre_padre'];?>">
                        <span class="invalid-feedback">Introducir un nombre <strong>debe constar mínimo de 3 letras</strong></span>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="dni_padre" class="control-label">DNI del padre</label>
                        <input type="text" class="form-control" name="dni_padre" placeholder="DNI del padre" required pattern="\d{8}\w" value ="<?php echo $alumno['dni_padre'];?>">
                        <span class="invalid-feedback">El campo DNI debe constar de <strong>8 Números y 1 Letra</strong></span>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="apellidos_padre" placeholder="Apellidos del padre" required pattern="[a-zA-Z\s]{3,40}" value ="<?php echo $alumno['apellidos_padre'];?>">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="tel_padre" placeholder="Teléfono del padre" required pattern="^\d{9}$" value ="<?php echo $alumno['tel_padre'];?>">
                    ...
                    <div class="col-md-8 mb-3">
                        ...
                        <input type="text" class="form-control" name="email_padre" placeholder="E-mail del padre" required pattern="^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$" value ="<?php echo $alumno['correo_padre'];?>">
                        <span class="invalid-feedback">Debe introducir un email válido</span>
                    </div>
                </div>
            </fieldset>
			 ...
			 <fieldset>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="nombre_madre" placeholder="Nombre de la madre" required pattern="[a-zA-Z\s]{3,40}" value ="<?php echo $alumno['nombre_madre'];?>">
                        <span class="invalid-feedback">Introducir un nombre <strong>debe constar mínimo de 3 letras</strong></span>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="dni_madre" class="control-label">DNI de la madre</label>
                        <input type="text" class="form-control" name="dni_madre" placeholder="DNI de la madre" required pattern="\d{8}\w" value ="<?php echo $alumno['dni_madre'];?>">
                        <span class="invalid-feedback">El campo DNI debe constar de <strong>8 Números y 1 Letra</strong></span>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" name="apellidos_madre" placeholder="Apellidos de la madre" required pattern="[a-zA-Z\s]{3,40}" value ="<?php echo $alumno['apellidos_madre'];?>">
                        <span class="invalid-feedback">Introducir los apellidos <strong>debe constar mínimo de 3 letras</strong></span>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="tel_madre" placeholder="Teléfono de la madre" required pattern="^\d{9}$" value ="<?php echo $alumno['tel_madre'];?>">
                        <span class="invalid-feedback">Introducir un teléfono <strong>debe constar de 9 dígitos</strong></span>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="email_madre" class="control-label">E-mail de la madre</label>
                        <input type="text" class="form-control" name="E-mail_madre" placeholder="email del madre" required pattern="^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$" value ="<?php echo $alumno['correo_madre'];?>">
                        <span class="invalid-feedback">Debe introducir un email válido</span>
                    </div>
                </div>
            </fieldset>
