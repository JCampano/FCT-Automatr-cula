            ...
            <fieldset>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="apellido2" placeholder="Segundo Apellido" value="<?php echo $alumno['apellido2'];?>" required pattern="[a-zA-Z\s]{3,40}">
                        <span class="invalid-feedback">Introduzca un apellido mínimo de <strong>3 letras</strong></span>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="dni" placeholder="DNI" value="<?php echo $alumno['dni'];?>" required pattern="\d{8}\w">
...
<?php echo $alumno['clave'];?>" placeholder="Contrase&ntilde;a">
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="direccion" placeholder="Dirección" value="<?php echo $alumno['direccion'];?>" required pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ,º0-9\s]{3,40}">
