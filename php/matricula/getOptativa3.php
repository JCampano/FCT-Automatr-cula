...
$conexion ->set_charset("utf8");//asi es el caracter utf8 si es msqli
	...
	$sql.=" AND optativas.id !='".$opt2."';";
	$res = $conexion->query($sql);
	//montamos el codigo html del combo de cursos
	//recorremos los cursos para crear el desplegable
	
	$respuesta='<label>Optativa 3</label><select class="custom-select" name="selectOptativas3" id="selectOptativas3" onchange="getOptativa4();"><option value="Seleccione">Seleccione</option>';
    ...
    if($respuesta=='<label>Optativa 3</label><select class="custom-select" name="selectOptativas3" id="selectOptativas3" onchange="getOptativa4();"><option value="Seleccione">Seleccione</option>'){
    }
	$respuesta.="</select>";
