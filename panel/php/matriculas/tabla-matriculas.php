    ...
    if($r=="s"){
        ...
        for($i=0;$i<count($resultado);$i++){
            ...
            echo '  <tr>
                        ...
                        <td width="100"><button style="margin-right:10px;" class="btn-ver" data-id="'.$resultado[$i]["idMatricula"].'" type="button" data-toggle="modal" data-target="#verMatricula"  data-tipo="tooltip" data-placement="down" title="Ver información">
