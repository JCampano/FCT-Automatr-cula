                                              ...
                                              <div class="card-body">
                                                  <form action="php/datosPersonales/modificarContrasena.php" method="post">
                                                   <div class="form-group row">
                                                     ...
                                                     <div class="col-sm-4">
                                                       <input type="password" class="form-control" required id="actual" name="actual" placeholder="Introduce tu contraseña actual">
                                                     </div>
                                                   </div>
                                                   <div class="form-group row">
                                                     <label for="Nueva" class="col-sm-3 col-form-label">Nueva</label>
                                                     <div class="col-sm-4">
                                                       <input type="password" class="form-control" required id="pass1" name="pass1" placeholder="Introduce tu nueva contraseña">
                                                     </div>
                                                   </div>
                                                   <div class="form-group row">
                                                     <label for="Nueva" class="col-sm-3 col-form-label">Nueva</label>
                                                     <div class="col-sm-4">
                                                       <input type="password" class="form-control" required id="pass2" name="pass2" placeholder="Repite tu nueva contraseña">
                                                     </div>
                                                   </div>
                                                   <div class="form-group row">
                                                    <div class="col-sm-10">
